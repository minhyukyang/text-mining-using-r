...
# https://www.clien.net/service/search?q=핸드폰
...
str_replace_all(title_cl, "\n|\t", "")


title_cl <- gsub("\n|\t", "", title_cl) 
title_cl <- gsub("\t", "", title_cl) 

content_cl <- gsub("\n", "", content_cl) 
content_cl <- gsub("\t", "", content_cl) 

click_cnt_cl <- gsub("\\D", "", click_cnt_cl) 

comment_cl <- gsub("\n", "", comment_cl) 
comment_cl <- gsub("\t", "", comment_cl) 

comment_cnt_cl <- gsub("\\D", "", comment_cnt_cl) 
